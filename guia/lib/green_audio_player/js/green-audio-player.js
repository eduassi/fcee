        ...
        function (require, module, exports) {
          ...
          var GreenAudioPlayer = /*#__PURE__*/ (function () {
            function GreenAudioPlayer(player, options) {
              ...
              this.playPauseBtn = this.audioPlayer.querySelector(
                ".play-pause-btn"
              );
              ...
              this.volumeBtn = this.audioPlayer.querySelector(
                ".volume__button"
              );
              this.volumeControls = this.audioPlayer.querySelector(
                ".volume__controls"
              );
              ...
              this.downloadLink = this.audioPlayer.querySelector(
                ".download__link"
              );
              ...
              if ("autoplay" in this.player.attributes) {
                ...
                if (promise !== undefined) {
                  promise
                    .then(function () {
                      var playPauseButton = self.player.parentElement.querySelector(
              ...
              [
                ...
                },
                {
                  ...
                  value: function updateProgress() {
                    ...
                    this.currentTime.textContent = GreenAudioPlayer.formatTime(
                      current
                    );
                  },
                },
